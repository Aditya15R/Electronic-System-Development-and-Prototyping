...
### DAC 3 constraints
set_property -dict { PACKAGE_PIN J2	 IOSTANDARD LVCMOS33 } [get_ports { dac_data3[11] }]; 
set_property -dict { PACKAGE_PIN H1	 IOSTANDARD LVCMOS33 } [get_ports { dac_data3[10] }]; 
set_property -dict { PACKAGE_PIN H2	 IOSTANDARD LVCMOS33 } [get_ports { dac_data3[9] }]; 
set_property -dict { PACKAGE_PIN F2  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[8] }]; 
set_property -dict { PACKAGE_PIN F1  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[7] }]; 
set_property -dict { PACKAGE_PIN E2  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[6] }]; 
set_property -dict { PACKAGE_PIN G1  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[5] }]; 
set_property -dict { PACKAGE_PIN D1  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[4] }]; 
set_property -dict { PACKAGE_PIN D2  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[3] }]; 
set_property -dict { PACKAGE_PIN C1  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[2] }]; 
set_property -dict { PACKAGE_PIN B1  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[1] }]; 
set_property -dict { PACKAGE_PIN B2  IOSTANDARD LVCMOS33 } [get_ports { dac_data3[0] }];
