...
################################    ADC  ############################################
### ADC 1 constraints
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { adc_1[9] }]; 
set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS33 } [get_ports { adc_1[8] }]; 
set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS33 } [get_ports { adc_1[7] }]; 
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS33 } [get_ports { adc_1[6] }]; 
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { adc_1[5] }]; 
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { adc_1[4] }]; 
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS33 } [get_ports { adc_1[3] }]; 
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS33 } [get_ports { adc_1[2] }]; 
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { adc_1[1] }]; 
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { adc_1[0] }];

## ADC 2 constraints
set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { adc_2[9] }]; 
set_property -dict { PACKAGE_PIN B3    IOSTANDARD LVCMOS33 } [get_ports { adc_2[8] }]; 
set_property -dict { PACKAGE_PIN A3    IOSTANDARD LVCMOS33 } [get_ports { adc_2[7] }]; 
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { adc_2[6] }]; 
set_property -dict { PACKAGE_PIN B5    IOSTANDARD LVCMOS33 } [get_ports { adc_2[5] }]; 
set_property -dict { PACKAGE_PIN A5    IOSTANDARD LVCMOS33 } [get_ports { adc_2[4] }]; 
set_property -dict { PACKAGE_PIN B6    IOSTANDARD LVCMOS33 } [get_ports { adc_2[3] }]; 
set_property -dict { PACKAGE_PIN B10   IOSTANDARD LVCMOS33 } [get_ports { adc_2[2] }]; 
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { adc_2[1] }]; 
set_property -dict { PACKAGE_PIN A12   IOSTANDARD LVCMOS33 } [get_ports { adc_2[0] }];
...
## DAC 2 constraints
set_property -dict { PACKAGE_PIN J11 	IOSTANDARD LVCMOS33 } [get_ports { dac_2[11] }]; 
set_property -dict { PACKAGE_PIN K12   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[10] }]; 
set_property -dict { PACKAGE_PIN L12   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[9] }]; 
set_property -dict { PACKAGE_PIN M12  	IOSTANDARD LVCMOS33 } [get_ports { dac_2[8] }]; 
set_property -dict { PACKAGE_PIN M11 	IOSTANDARD LVCMOS33 } [get_ports { dac_2[7] }]; 
set_property -dict { PACKAGE_PIN K11   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[6] }]; 
set_property -dict { PACKAGE_PIN M10  	IOSTANDARD LVCMOS33 } [get_ports { dac_2[5] }]; 
set_property -dict { PACKAGE_PIN P5   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[4] }]; 
set_property -dict { PACKAGE_PIN P4  	IOSTANDARD LVCMOS33 } [get_ports { dac_2[3] }]; 
set_property -dict { PACKAGE_PIN N4   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[2] }]; 
set_property -dict { PACKAGE_PIN P3   	IOSTANDARD LVCMOS33 } [get_ports { dac_2[1] }]; 
set_property -dict { PACKAGE_PIN P2  	IOSTANDARD LVCMOS33 } [get_ports { dac_2[0] }];

### DAC 3 constraints
set_property -dict { PACKAGE_PIN J2	 IOSTANDARD LVCMOS33 } [get_ports { dac_3[11] }]; 
set_property -dict { PACKAGE_PIN H1	 IOSTANDARD LVCMOS33 } [get_ports { dac_3[10] }]; 
set_property -dict { PACKAGE_PIN H2	 IOSTANDARD LVCMOS33 } [get_ports { dac_3[9] }]; 
set_property -dict { PACKAGE_PIN F2  IOSTANDARD LVCMOS33 } [get_ports { dac_3[8] }]; 
set_property -dict { PACKAGE_PIN F1  IOSTANDARD LVCMOS33 } [get_ports { dac_3[7] }]; 
set_property -dict { PACKAGE_PIN E2  IOSTANDARD LVCMOS33 } [get_ports { dac_3[6] }]; 
set_property -dict { PACKAGE_PIN G1  IOSTANDARD LVCMOS33 } [get_ports { dac_3[5] }]; 
set_property -dict { PACKAGE_PIN D1  IOSTANDARD LVCMOS33 } [get_ports { dac_3[4] }]; 
set_property -dict { PACKAGE_PIN D2  IOSTANDARD LVCMOS33 } [get_ports { dac_3[3] }]; 
set_property -dict { PACKAGE_PIN C1  IOSTANDARD LVCMOS33 } [get_ports { dac_3[2] }]; 
set_property -dict { PACKAGE_PIN B1  IOSTANDARD LVCMOS33 } [get_ports { dac_3[1] }]; 
set_property -dict { PACKAGE_PIN B2  IOSTANDARD LVCMOS33 } [get_ports { dac_3[0] }];
